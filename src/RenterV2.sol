...
contract RenterV2 is IERC721Receiver {
    ...
    function rentOne(IERC721 _nft, uint256 _tokenId) public payable {
        ...
        require(
            msg.value >= listings[_nft][_tokenId].rentPrice,
            "Not enough rent money sent"
        );
        require(
        ...
        payable(listings[_nft][_tokenId].owner).transfer(
            (msg.value * 9850) / 10000
        );
